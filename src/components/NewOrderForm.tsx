...
export default function NewOrderForm() {
  ...
  const inputClass = "w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2.5 text-gray-900 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent";
        ...
        <div className="bg-green-50 border border-green-200 rounded-xl p-4 space-y-2">
          ...
          <div className="flex items-center gap-2">
            <input
              readOnly
              value={success.link}
              className="flex-1 bg-white border border-gray-200 rounded-lg px-3 py-2 text-gray-600 text-sm font-mono"
            />
            <button
          ...
          <p className="text-gray-500 text-xs">
            Enviá este link al cliente para que pueda rastrear su pedido.
          </p>
        </div>
      )}
    </div>
