...
const selectClass = "bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-400";
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <input
          ...
          className="bg-white border border-gray-200 rounded-lg px-3 py-2 text-gray-700 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 col-span-2 sm:col-span-1"
        />
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {filtered.map((order, i) => (
                <tr
                  key={order.id}
                  className={`border-b border-gray-50 hover:bg-blue-50/50 transition-colors ${i % 2 === 0 ? "" : "bg-gray-50/50"}`}
                >
                  ...
                  <td className="px-4 py-3">
                    <span className="block text-xs font-semibold text-blue-500">{order.phaseLabel}</span>
                  ...
                  <td className="px-4 py-3">
                    <a
                      ...
                      target="_blank"
                      className="text-blue-500 font-mono text-xs hover:underline"
                    >
                      {order.tracking_code}
                    </a>
                  </td>
