...
export const INTERNAL_STATES: Record<ProductType, InternalState[]> = {
  motorcycle: [
    ...
    { day: 46, phase: "transito_maritimo",    titulo: "En tránsito marítimo",            texto: "La carga continúa navegando hacia Cuba." },
    { day: 49, phase: "llego_a_cuba_aduana",  titulo: "Arribo al puerto de Cuba",        texto: "Llegada del buque al puerto de destino." },
    { day: 54, phase: "llego_a_cuba_aduana",  titulo: "Descarga del contenedor",         texto: "La motocicleta es descargada del buque." },
    { day: 59, phase: "llego_a_cuba_aduana",  titulo: "Ingreso a Aduana Cubana",         texto: "Inicia el proceso de importación." },
    { day: 65, phase: "llego_a_cuba_aduana",  titulo: "Revisión documental",             texto: "Se valida la documentación presentada." },
    { day: 72, phase: "llego_a_cuba_aduana",  titulo: "Inspección física",               texto: "Las autoridades inspeccionan la motocicleta." },
    { day: 79, phase: "llego_a_cuba_aduana",  titulo: "Gestión documental del vehículo", texto: "Se completan los trámites administrativos necesarios antes de la entrega." },
  ...
  solar_kit: [
    ...
    { day: 54,  phase: "transito_maritimo",    titulo: "En tránsito marítimo",            texto: "La carga continúa su recorrido." },
    { day: 57,  phase: "llego_a_cuba_aduana",  titulo: "Arribo al puerto de Cuba",        texto: "Llegada del buque al puerto de destino." },
    { day: 63,  phase: "llego_a_cuba_aduana",  titulo: "Descarga del contenedor",         texto: "La carga es descargada." },
    { day: 69,  phase: "llego_a_cuba_aduana",  titulo: "Ingreso a Aduana Cubana",         texto: "Comienza el proceso de importación." },
    { day: 78,  phase: "llego_a_cuba_aduana",  titulo: "Revisión documental",             texto: "Se verifica toda la documentación." },
    { day: 92,  phase: "llego_a_cuba_aduana",  titulo: "Inspección de la carga",          texto: "Se inspeccionan los componentes del kit solar." },
    { day: 104, phase: "llego_a_cuba_aduana",  titulo: "Liquidación de impuestos",        texto: "Se calculan y aplican los aranceles correspondientes a la importación." },
  ...
  electric_tricycle: [
    ...
    { day: 54,  phase: "transito_maritimo",    titulo: "En tránsito marítimo",            texto: "El contenedor continúa navegando hacia el puerto de destino." },
    { day: 57,  phase: "llego_a_cuba_aduana",  titulo: "Arribo al puerto de Cuba",        texto: "El buque llega al puerto de destino." },
    { day: 63,  phase: "llego_a_cuba_aduana",  titulo: "Descarga del contenedor",         texto: "La carga es descargada del buque." },
    { day: 70,  phase: "llego_a_cuba_aduana",  titulo: "Ingreso a Aduana Cubana",         texto: "Comienza el proceso de importación." },
    { day: 82,  phase: "llego_a_cuba_aduana",  titulo: "Revisión documental",             texto: "Se valida toda la documentación presentada." },
    { day: 96,  phase: "llego_a_cuba_aduana",  titulo: "Inspección física",               texto: "Las autoridades realizan la inspección del vehículo." },
    { day: 110, phase: "llego_a_cuba_aduana",  titulo: "Gestión documental del vehículo", texto: "Se completan los trámites administrativos necesarios antes de la entrega." },
